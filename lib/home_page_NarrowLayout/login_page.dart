...
class LoginPageUltra extends StatefulWidget {
  const LoginPageUltra({Key? key}) : super(key: key);

  @override
  State<LoginPageUltra> createState() => _LoginPageUltraState();
}
...
class _LoginPageUltraState extends State<LoginPageUltra> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          const Padding(
            padding: EdgeInsets.only(left: 24, top: 5, bottom: 18),
            child: Text(
              "Hey,\nLogin now.",
              style: TextStyle(
                fontSize: 32,
